    ...
    <nav class="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
        <div class="flex lg:flex-1">
            <a href="https://github.com/z0mbiebrad" class="-m-1.5 p-1.5 flex items-center space-x-2">
                <span class="sr-only">z0mbiebrad's Github profile.</span>
                ...
                <p class="text-white font-bold">github/z0mbiebrad</p>
            </a>
        </div>
        @auth
    ...
    <div class="hidden" role="dialog" aria-modal="true" id="mobile-menu">
        ...
        <div
            ...
            <div class="flex items-center justify-between">
                <a href="https://github.com/z0mbiebrad" class="-m-1.5 p-1.5">
                    <span class="sr-only">z0mbiebrad's Github profile.</span>
                    <svg class="h-10" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 496 512"><!--!Font Awesome Free 6.6.0 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.-->
                        <path fill="white"
                ...
                <button type="button" class="-m-2.5 rounded-md p-2.5 text-gray-400" id="close-menu">
            ...
            <div class="mt-6 flow-root">
                <div class="-my-6 divide-y divide-gray-500/25">
                    <div class="py-6">
                        @auth
                            <a href="{{ route('post.index') }}"
                                class="block rounded-md px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Posts</a>
                            <a href="{{ route('post.create') }}"
                                class="rounded-md px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white">Upload
                                Post</a>
                            <div
                                class="mt-none block rounded-md px-3 py-2 text-lg font-medium text-gray-300 hover:bg-gray-700 hover:text-white">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const closeButton = document.getElementById('close-menu'); // Corrected the ID
